...
public class ChangeTextBehaviorTest {
    ...
    private final String appName = "Calendar";
    ...
    public void initialApp(){
        ...
        UiObject2 appButton = mDevice.findObject(By.desc("Apps"));
        appButton.click();
        mDevice.wait(Until.hasObject(By.text("Calculator")),3000);

        UiObject2 calcApp = mDevice.findObject(By.text("Calculator"));
        calcApp.click();
    }
    ...
    public void testAdd() throws Exception {
        ...
        mDevice.wait(Until.hasObject(By.text("9")), 3000);

        // Select the button for 9
        UiObject2 buttonNine = mDevice.findObject(By.text("9"));
        buttonNine.click();

        // Select the button for +
        UiObject2 buttonPlus = mDevice.findObject(By.desc("plus"));
        buttonPlus.click();
        ...
        // Select the button for =
        UiObject2 buttonEquals = mDevice.findObject(By.desc("equals"));
        buttonEquals.click();

        mDevice.waitForIdle(3000);

        UiObject2 resultText = mDevice.findObject(By.clazz("android.widget.EditText"));
